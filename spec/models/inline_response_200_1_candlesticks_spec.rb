...
# Unit tests for RakutenTrading::InlineResponse2001Candlesticks
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'InlineResponse2001Candlesticks' do
  before do
    # run before each test
    @instance = RakutenTrading::InlineResponse2001Candlesticks.new
  end
  ...
  describe 'test an instance of InlineResponse2001Candlesticks' do
    it 'should create an instance of InlineResponse2001Candlesticks' do
      expect(@instance).to be_instance_of(RakutenTrading::InlineResponse2001Candlesticks)
    end
  end
